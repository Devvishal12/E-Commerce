...
import Label from "../../Label"; // plasmic-import: WWUYgiNbqHh6/component
import TextInput2 from "../../TextInput2"; // plasmic-import: Ujg1hRoUVmLz/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: PTywS8k5lqR1/component
import Description from "../../Description"; // plasmic-import: eKgU3cCDEVhe/component
import "@plasmicapp/react-web/lib/plasmic.css";
import projectcss from "./plasmic.module.css"; // plasmic-import: riVYfd7Jgv4QCX85Q24XGF/projectcss
import sty from "./PlasmicTextField.module.css"; // plasmic-import: RU3mE6_LKxHE/css
...
function PlasmicTextField__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__jbPWg, {
          [sty.freeBoxiconEnd__jbPWgxviYt]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__jbPWgSzGzH]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__jbPWgWzbY]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__g90Kh, {
            [sty.freeBoxiconStart__g90KhSzGzH]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__g90KhWzbY]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__qieEf)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__f3L6V, {
            [sty.freeBoxiconEnd__f3L6VxviYt]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__f3L6VSzGzH]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__q7X7I)}
                role={"img"}
              />
            ),
